...
const all_abi = abi;
all_abi.variants = abi.variants.concat(system_abi.variants);
all_abi.structs = abi.structs.concat(system_abi.structs);

const types = Serialize.getTypesFromAbi(Serialize.createInitialTypes(), all_abi);

module.exports = {abi, types};